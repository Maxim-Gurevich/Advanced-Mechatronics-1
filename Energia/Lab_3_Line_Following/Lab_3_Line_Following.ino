...
void loop()
{
  ...
  */
  ...
  //Develop your state machine here
    ...
    if (linePos > 3000 && sensorVal[0] > 1000 && sensorVal[1] > 1000 && sensorVal[6] > 1000 && sensorVal[7] > 1000 && count == 1) {
        Current_Time = millis();       
    ...
    else if (linePos > 3000 && sensorVal[0] > 1000 && sensorVal[1] > 1000 && sensorVal[6] > 1000 && sensorVal[7] > 1000 && count == 2) {
        Current_Time = millis();       
        
        while (millis() - Current_Time <= 900) {
          setMotorSpeed(LEFT_MOTOR, fastSpeed);
    ...
    else if (linePos > 3000 && sensorVal[0] > 1000 && sensorVal[1] > 1000 && sensorVal[6] > 1000 && sensorVal[7] > 1000 && count == 3) {
           Current_Time = millis();       
